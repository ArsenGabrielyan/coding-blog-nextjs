...
import Image from "next/image"; import BlogPost from "./BlogPost";
     ...
     return <div className="results">
          <div className="results-single-post">
               ...
               <div className="single-post">
                    <div className="single-post-header"><Image src={postData.banner.file || '/images/post-header.webp'} alt="banner" fill priority/></div>
                    <div className="single-post-body">
                         ...
                         <div className="content"><MarkdownContent>{postData.content}</MarkdownContent></div>
